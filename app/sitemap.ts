...
export default function sitemap(): MetadataRoute.Sitemap {
  const lastModified = new Date("2026-09-22T14:15:00-04:00");
  ...
  return [
    ...
    { url: "https://www.davidschunk.com/research/russia-policy", lastModified, changeFrequency: "monthly", priority: 0.9 },
  ];
}
